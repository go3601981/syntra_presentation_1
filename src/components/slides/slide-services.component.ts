      ...
      <div class="relative z-10 w-full max-w-6xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          @for (service of services; track service.id) {
            <div 
              class="group relative p-10 rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl hover:bg-white/10 hover:border-syntra-action-primary/50 transition-all duration-700 animate-slide-up overflow-hidden"
